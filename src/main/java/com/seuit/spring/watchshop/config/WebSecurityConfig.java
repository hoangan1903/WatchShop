...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.authorizeRequests()
				...
				.antMatchers("/admin/CRUD_Alert/**","/admin/CRUD_User/**").hasRole("admin")
				.antMatchers("/admin/CRUD_Employees/**","/admin/CRUD_Products/**","/admin/report/**","/admin/feedback/**","/admin/CRUD_OtherFunction/**").hasRole("manager")
				...
				.antMatchers("/admin/list_Customers/**","/admin/order/**").hasRole("employee")
				.antMatchers("/cart", "/checkout/**", "/account").hasRole("customer")
				.antMatchers(HttpMethod.GET, "/rest/cart").hasRole("customer")
				.antMatchers(HttpMethod.POST, "/rest/cart").hasRole("customer")
				.antMatchers("/admin*").hasAnyRole("admin", "manager", "employee")
				.antMatchers("/**").permitAll()
				.and()
				.formLogin()
				.loginPage("/login").defaultSuccessUrl("/", true).failureUrl("/login?error=true").permitAll()
				.and()
				.exceptionHandling()
				.and()
				.logout().permitAll()
				.logoutRequestMatcher(new AntPathRequestMatcher("/logout", "GET")).deleteCookies("JSESSIONID").clearAuthentication(true)
				.and()
