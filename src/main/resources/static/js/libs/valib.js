...
(function (global, jQuery, factory) {
...
})(window, typeof jQuery !== "undefined" ? jQuery : null, function (global, jQuery) {
    ...
    var getIndexByPosition = function (array, position) {
    ...
    valib.extend(valib, {
        ...
        isArrayLike: function (obj) {
            var length = !!obj && "length" in obj && obj.length,
                type = valib.typeOf(obj);

            if (valib.isFunction(obj) || obj === global) {
                return false;
            }
        ...
        */
        ajaxGET: function (url, onReceive) {
            if (url && onReceive) {
    ...
    var getURLParams = function () {
        ...
        // If there are no arguments then process current page's query string
        // Otherwise process the query string passed as the argument
        let queryString = arguments.length === 0 ? global.location.search : arguments[0];
    ...
    valib.extend(valib, {
        ...
        getURLWithParams: function (url, params) {
            if (params) {
                ...
                if (totalParams > 0) {
                    let paramArr, queryString, urlWithParams;

                    paramArr = valib.mapObj(params, (value, key) => key + "=" + encodeURI(value));
    ...
    // Expose valib to global context
    global.valib = valib;
